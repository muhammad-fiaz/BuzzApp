...
class AppThemeData {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    colorScheme: const ColorScheme.light(primary: appColorPrimary, onPrimary: whiteColor).copyWith(secondary: appColorPrimary),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    visualDensity: VisualDensity.adaptivePlatformDensity,
    colorScheme: const ColorScheme.dark(primary: appBackgroundColorDark, onPrimary: cardBackgroundBlackDark).copyWith(secondary: whiteColor),
  ).copyWith(
    pageTransitionsTheme: const PageTransitionsTheme(builders: <TargetPlatform, PageTransitionsBuilder>{
      TargetPlatform.android: OpenUpwardsPageTransitionsBuilder(),
      TargetPlatform.iOS: CupertinoPageTransitionsBuilder(),
